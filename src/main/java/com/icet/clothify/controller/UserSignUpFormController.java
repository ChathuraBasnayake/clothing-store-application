...
public class UserSignUpFormController {
    ...
    void btnCreateAccountOnAction(ActionEvent event) {
        ...
        boolean state = userService.addUser(new UserDTO(1, txtFirstName.getText() + " " + txtLastName.getText(), txtCompany.getText(), txtEmail.getText(), txtPassword.getText(), txtConfirmPassword.getText(), checkBoxAdmin.isSelected()));
